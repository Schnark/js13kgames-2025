...
levels = [
	...
	[new Level(
		...
		[
			...
			new Block(
				new Curve([{x: 1400, y: 380}, {x: 1600, y: 320, xc: 1500, yc: 340}, {x: 1850, y: 360, xc: 1700}]),
	...
	[new Level(
		...
		[
			new Block(
				new Curve([{x: 250, y: 600}, {x: 800, y: 600}]),
				new Curve([{x: 250, y: 650}, {x: 800, y: 650, xc: 525, yc: 700}]),
				3
			),
			new Block(
			...
			new Block(
				new Curve([{x: 2300, y: 600}, {x: 2850, y: 600}]),
				new Curve([{x: 2300, y: 650}, {x: 2850, y: 650, xc: 2575, yc: 700}]),
				3
			)
		],
		[[1100, 2000]],
